...
class MediaController extends Controller
{
    ...
    public function getModelInstance($model = 'users'){
        ...
        if($model === 'musicianProfilePictures'){
            return (new MusicianProfilePicture());
        }
        if($model === 'musicianVideos'){
            return (new MusicianVideo());
        }
        if($model === 'musicAlbums'){
            return (new MusicAlbum());
        }
        if($model === 'musicRecords'){
