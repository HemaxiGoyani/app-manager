<div class="col-sm-9">
    ...
    <div class="form-group col-sm-12">
        ...
        {!! Form::text('name', null, ['class' => 'form-control', 'placeholder'=>'Name of musician video']) !!}
...
<div class="sImageOuterContainer col-sm-3">
    <div id="sImageContainer_id" class='sImageContainer mayContainError fastAnimation' tabindex='1'>
        <div class='sImagePlaceholderDiv {{ isset($musicianVideo) ? 'd-none' : '' }}'>
            <div class='sImagePlaceholderText text-center'>
                Select User Avatar<br/>(Max: 1 MB)
            </div>
        </div>
        <div class='sImagePreview {{ isset($musicianVideo) ? '' : 'd-none' }}'>
            <img id='sImagePreview_id' class='sImagePreviewImg' alt='Avatar'
                 src='{{ isset($musicianVideo) ? $musicianVideo->avatar_url['250'] : route('images_default',['resolution' => '250x250']) }}'
            />
...
<div class="form-group col-sm-12">
    ...
    <a href="{{ route('admin.musicianVideos.index') }}" class="btn btn-default">Cancel</a>
</div>
@push('stackedScripts')
